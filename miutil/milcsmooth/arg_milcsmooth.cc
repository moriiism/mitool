...
void ArgValMilcsmooth::Init(int argc, char* argv[])
{
    progname_ = "milcsmooth";
...
void ArgValMilcsmooth::Print(FILE* fp) const
{
...
void ArgValMilcsmooth::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
        MPrintInfo("start...");
    }
...
void ArgValMilcsmooth::Usage(FILE* fp) const
{
    fprintf(fp,
