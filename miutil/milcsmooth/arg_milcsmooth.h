#ifndef MORIIISM_MITOOL_MIUTIL_MILCSMOOTH_ARG_MILCSMOOTH_H_
#define MORIIISM_MITOOL_MIUTIL_MILCSMOOTH_ARG_MILCSMOOTH_H_

#include "mi_base.h"

class ArgValMilcsmooth : public MiArgBase{
public:
    ArgValMilcsmooth() :
        MiArgBase(),
        progname_(""),
...
#endif // MORIIISM_MITOOL_MIUTIL_MILCSMOOTH_ARG_MILCSMOOTH_H_
