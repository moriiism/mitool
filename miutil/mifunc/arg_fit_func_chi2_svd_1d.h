#ifndef MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_FIT_FUNC_CHI2_SVD_1D_H_
#define MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_FIT_FUNC_CHI2_SVD_1D_H_

#include "mi_base.h"

class ArgValFitFuncChi2Svd1d : public MiArgBase{
public:
    ArgValFitFuncChi2Svd1d() :
        MiArgBase(),
        progname_(""),
        data_file_(""),
        data_fmt_(""),
...
#endif // MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_FIT_FUNC_CHI2_SVD_1D_H_
