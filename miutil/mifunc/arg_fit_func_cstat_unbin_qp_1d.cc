...
void ArgValFitFuncCstatUnbinQp1d::Init(int argc, char* argv[])
{
    progname_ = "fit_func_cstat_unbin_qp_1d";
...
void ArgValFitFuncCstatUnbinQp1d::Print(FILE* fp) const
{
...
void ArgValFitFuncCstatUnbinQp1d::Null()
{
    progname_ = "";
    data_file_ = "";
    func_par_list_ = "";
...
void ArgValFitFuncCstatUnbinQp1d::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
        MPrintInfo("start...");
    }
...
void ArgValFitFuncCstatUnbinQp1d::Usage(FILE* fp) const
{
    fprintf(fp,
