#ifndef MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_FIT_FUNC_CSTAT_EM_1D_H_
#define MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_FIT_FUNC_CSTAT_EM_1D_H_

#include "mi_base.h"

class ArgValFitFuncCstatEm1d : public MiArgBase{
public:
    ArgValFitFuncCstatEm1d() :
        MiArgBase(),
        progname_(""),
        data_file_(""),
        data_fmt_(""),
...
#endif // MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_FIT_FUNC_CSTAT_EM_1D_H_
