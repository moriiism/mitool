#include "arg_sim_func_2d.h"

// public

void ArgValSimFunc2d::Init(int argc, char* argv[])
{
    progname_ = "sim_func_2d";
...
void ArgValSimFunc2d::Print(FILE* fp) const
{
...
void ArgValSimFunc2d::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
        MPrintInfo("start...");
    }
...
void ArgValSimFunc2d::Usage(FILE* fp) const
{
    fprintf(fp,
