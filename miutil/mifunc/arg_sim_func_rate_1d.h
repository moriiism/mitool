#ifndef MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_SIM_FUNC_RATE_1D_H_
#define MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_SIM_FUNC_RATE_1D_H_

#include "mi_base.h"

class ArgValSimFuncRate1d : public MiArgBase{
public:
    ArgValSimFuncRate1d() :
        MiArgBase(),
        progname_(""),
...
#endif // MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_SIM_FUNC_RATE_1D_H_
