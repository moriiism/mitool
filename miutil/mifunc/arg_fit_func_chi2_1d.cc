...
void ArgValFitFuncChi21d::Init(int argc, char* argv[])
{
    progname_ = "fit_func_chi2_1d";
...
void ArgValFitFuncChi21d::Print(FILE* fp) const
{
...
void ArgValFitFuncChi21d::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
        MPrintInfo("start...");
    }
...
void ArgValFitFuncChi21d::Usage(FILE* fp) const
{
    fprintf(fp,
