#ifndef MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_FIT_FUNC_CSTAT_UNBIN_EM_1D_H_
#define MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_FIT_FUNC_CSTAT_UNBIN_EM_1D_H_

#include "mi_base.h"

class ArgValFitFuncCstatUnbinEm1d : public MiArgBase{
public:
    ArgValFitFuncCstatUnbinEm1d() :
        MiArgBase(),
        progname_(""),
        data_file_(""),
        func_par_list_(""),
...
#endif // MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_FIT_FUNC_CSTAT_UNBIN_EM_1D_H_
