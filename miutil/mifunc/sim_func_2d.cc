...
int main(int argc, char* argv[]){
    ...
    ArgValSimFunc2d* argval = new ArgValSimFunc2d;
    ...
    if("bin" == argval->GetSimMode()){
        ...
        MirQdpTool::MkQdpDiffProjSerr(hd2d_sim_count, func, func_par->GetPar(),
        ...
        MirQdpTool::MkQdpDiffProjSerr(hd2d_evt_fill, func, func_par->GetPar(),
