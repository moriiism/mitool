...
void ArgValDrawFuncList1d::Init(int argc, char* argv[])
{
    progname_ = "draw_func_list_1d";
...
void ArgValDrawFuncList1d::Print(FILE* fp) const
{
...
void ArgValDrawFuncList1d::Null()
{
    progname_ = "";
    func_par_list_ = "";
    plot_conf_file_ = "";
...
void ArgValDrawFuncList1d::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
        MPrintInfo("start...");
    }
...
void ArgValDrawFuncList1d::Usage(FILE* fp) const
{
    fprintf(fp,
