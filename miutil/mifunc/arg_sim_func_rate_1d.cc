...
void ArgValSimFuncRate1d::Init(int argc, char* argv[])
{
    progname_ = "sim_func_rate_1d";
...
void ArgValSimFuncRate1d::Print(FILE* fp) const
{
...
void ArgValSimFuncRate1d::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
        MPrintInfo("start...");
    }
...
void ArgValSimFuncRate1d::Usage(FILE* fp) const
{
    fprintf(fp,
