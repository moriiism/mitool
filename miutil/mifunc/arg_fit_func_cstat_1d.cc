...
void ArgValFitFuncCstat1d::Init(int argc, char* argv[])
{
    progname_ = "fit_func_cstat_1d";
...
void ArgValFitFuncCstat1d::Print(FILE* fp) const
{
...
void ArgValFitFuncCstat1d::Null()
{
    progname_ = "";
    data_file_ = "";
    data_fmt_ = "";
...
void ArgValFitFuncCstat1d::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
        MPrintInfo("start...");
    }
...
void ArgValFitFuncCstat1d::Usage(FILE* fp) const
{
    fprintf(fp,
