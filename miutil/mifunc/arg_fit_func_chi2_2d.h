#ifndef MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_FIT_FUNC_CHI2_2D_H_
#define MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_FIT_FUNC_CHI2_2D_H_

#include "mi_base.h"

class ArgValFitFuncChi22d : public MiArgBase{
public:
    ArgValFitFuncChi22d() :
        MiArgBase(),
        progname_(""),
...
#endif // MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_FIT_FUNC_CHI2_2D_H_
