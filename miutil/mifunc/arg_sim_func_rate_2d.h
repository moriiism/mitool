#ifndef MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_SIM_FUNC_RATE_2D_H_
#define MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_SIM_FUNC_RATE_2D_H_

#include "mi_base.h"

class ArgValSimFuncRate2d : public MiArgBase{
public:
    ArgValSimFuncRate2d() :
        MiArgBase(),
        progname_(""),
...
#endif // MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_SIM_FUNC_RATE_2D_H_
