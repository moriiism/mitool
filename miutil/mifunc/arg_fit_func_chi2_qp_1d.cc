...
void ArgValFitFuncChi2Qp1d::Init(int argc, char* argv[])
{
    progname_ = "fit_func_chi2_qp_1d";
...
void ArgValFitFuncChi2Qp1d::Print(FILE* fp) const
{
...
void ArgValFitFuncChi2Qp1d::Null()
{
    progname_ = "";
    data_file_ = "";
    data_fmt_ = "";
...
void ArgValFitFuncChi2Qp1d::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
        MPrintInfo("start...");
    }
...
void ArgValFitFuncChi2Qp1d::Usage(FILE* fp) const
{
    fprintf(fp,
