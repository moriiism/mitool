...
void ArgValFitFuncCstatEm1d::Init(int argc, char* argv[])
{
    progname_ = "fit_func_cstat_em_1d";
...
void ArgValFitFuncCstatEm1d::Print(FILE* fp) const
{
...
void ArgValFitFuncCstatEm1d::Null()
{
    progname_ = "";
    data_file_ = "";
    data_fmt_ = "";
...
void ArgValFitFuncCstatEm1d::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
        MPrintInfo("start...");
    }
...
void ArgValFitFuncCstatEm1d::Usage(FILE* fp) const
{
    fprintf(fp,
