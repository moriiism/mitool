#ifndef MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_FIT_FUNC_CSTAT_1D_H_
#define MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_FIT_FUNC_CSTAT_1D_H_

#include "mi_base.h"

class ArgValFitFuncCstat1d : public MiArgBase{
public:
    ArgValFitFuncCstat1d() :
        MiArgBase(),
        progname_(""),
        data_file_(""),
        data_fmt_(""),
...
#endif // MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_FIT_FUNC_CSTAT_1D_H_
