#ifndef MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_DRAW_FUNC_LIST_2D_H_
#define MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_DRAW_FUNC_LIST_2D_H_

#include "mi_base.h"

class ArgValDrawFuncList2d : public MiArgBase{
public:
    ArgValDrawFuncList2d() :
        MiArgBase(),
        progname_(""),
        func_par_list_(""),
        plot_conf_file_(""),
...
#endif // MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_DRAW_FUNC_LIST_2D_H_
