#ifndef MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_DRAW_FUNC_1D_H_
#define MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_DRAW_FUNC_1D_H_

#include "mi_base.h"

class ArgValDrawFunc1d : public MiArgBase{
public:
    ArgValDrawFunc1d() :
        MiArgBase(),
        progname_(""),
...
#endif // MORIIISM_MITOOL_MIUTIL_MIFUNC_ARG_DRAW_FUNC_1D_H_
