...
//DataArray1d* const DataArray1d::GenDa1dByLoad(string file, string format)
//{
...
{
    double ans = MiMath::GetMin(GetNdata(), GetVal());
    return ans;
}

double DataArray1d::GetValMax() const
{
    double ans = MiMath::GetMax(GetNdata(), GetVal());
    return ans;
}

long DataArray1d::GetLocValMin() const
{
    long ans = MiMath::GetLocMin(GetNdata(), GetVal());
    return ans;
}

long DataArray1d::GetLocValMax() const
{
    long ans = MiMath::GetLocMax(GetNdata(), GetVal());
    return ans;
}

double DataArray1d::GetSum() const
{
    double ans = MiMath::GetAdd(GetNdata(), GetVal());
    return ans;
}

double DataArray1d::GetAMean() const
{
    double ans = MiMath::GetAMean(GetNdata(), GetVal());
    return ans;
}

double DataArray1d::GetVariance() const
{
    double ans = MiMath::GetVariance(GetNdata(), GetVal());
    return ans;
}

double DataArray1d::GetStddev() const
{
    double ans = MiMath::GetStddev(GetNdata(), GetVal());
    return ans;
}

double DataArray1d::GetUnbiasedVariance() const
{
    double ans = MiMath::GetUnbiasedVariance(GetNdata(), GetVal());
    return ans;
}

double DataArray1d::GetSqrtOfUnbiasedVariance() const
{
    double ans = MiMath::GetSqrtOfUnbiasedVariance(GetNdata(), GetVal());
    return ans;
}

double DataArray1d::GetRMS() const
{
    double ans = MiMath::GetRMS(GetNdata(), GetVal());
    return ans;
}
...
{
    double lo, up;
    MiMath::GetRangeQdp(0, GetNdata(), &lo, &up);
    *lo_ptr  = lo;
    *up_ptr  = up;
}
