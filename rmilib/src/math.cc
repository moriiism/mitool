...
int MiMath::IsOneOrZero(double val)
{
    int ans = IsOne(val) + IsZero(val);
    return ans;
}

int MiMath::IsPlus(double val)
{
    if (val > 0) return 1;
    return 0;
}

int MiMath::IsMinus(double val)
{
    if (val < 0) return 1;
    return 0;
}
...
double MiMath::FilterPlus(double val)
{
    if (val > 0) return val;
    return 0;
}

double MiMath::FilterMinus(double val)
{
    if (val < 0) return val;
    return 0;
}

int MiMath::Not(double val)
{
...
void MiMath::GetScaled(double val, double val_err, double scale, double offset,
...
int MiMath::IsSame(double aval, double bval)
{
    int retval = 0;
...
double MiMath::GetMin(double aval, double bval)
{
    double val = 0.0;
    if(aval <= bval){
        val = aval;
...
double MiMath::GetMax(double aval, double bval)
{
    double val = 0.0;
    if(aval >= bval){
        val = aval;
...
int MiMath::GetLocMin(double aval, double bval)
{
    if(aval <= bval){
        return 0;
    } else {
...
int MiMath::GetLocMax(double aval, double bval)
{
    if(aval >= bval){
        return 0;
    } else {
...
double MiMath::GetAMean(double aval, double bval)
{
...
void MiMath::GetAdd(double val1, double val1_err, double val2, double val2_err,
                      double* const ans_ptr, double* const ans_err_ptr)
{
...
void MiMath::GetSub(double val1, double val1_err, double val2, double val2_err,
                      double* const ans_ptr, double* const ans_err_ptr)
{
    double ans     = val1 - val2;
    double ans_err = sqrt( pow(val1_err, 2) + pow(val2_err, 2) );
...
void MiMath::GetMul(double val1, double val1_err, double val2, double val2_err,
                      double* const ans_ptr, double* const ans_err_ptr)
{
    double ans     = val1 * val2;
...
int MiMath::GetDiv(double val_num, double val_num_err, double val_den, double val_den_err,
                     double* const ans_ptr, double* const ans_err_ptr)
{
...
int MiMath::GetAMean(double val1, double val1_err, double val2, double val2_err,
...
int MiMath::GetWMean(double val1, double val1_err, double val2, double val2_err,
...
int MiMath::GetSubAddRatio(double val1, double val1_err, double val2, double val2_err,
                             double* const ans_ptr, double* const ans_err_ptr)
{
    int status = kRetNormal;
...
double MiMath::GetMin(long narr, const double* const val_arr)
{
    double val = *std::min_element(val_arr, val_arr + narr);
    return val;
}

double MiMath::GetMax(long narr, const double* const val_arr)
{
    double val = *std::max_element(val_arr, val_arr + narr);
    return val;
}

long MiMath::GetLocMin(long narr, const double* const val_arr)
{
    if(narr <= 0){
        abort();
    }
...
long MiMath::GetLocMax(long narr, const double* const val_arr)
{
    if(narr <= 0){
        abort();
    }
...
double MiMath::GetAdd(long narr, const double* const val_arr)
{
    double ans = 0.0;
...
double MiMath::GetAMean(long narr, const double* const val_arr)
{
    if(narr < 1){
...
double MiMath::GetVariance(long narr, const double* const val_arr)
{
    if(narr < 1){
        printf("ERROR: %s: %u: %s(): bad narr (= %ld)\n",
               __FILE__, __LINE__, __func__, narr);
...
double MiMath::GetStddev(long narr, const double* const val_arr)
{
    double stddev = sqrt( GetVariance(narr, val_arr) );
    return stddev;
}

double MiMath::GetUnbiasedVariance(long narr, const double* const val_arr)
{
    if(narr < 2){
        printf("ERROR: %s: %u: %s(): bad narr (= %ld)\n",
               __FILE__, __LINE__, __func__, narr);
...
double MiMath::GetSqrtOfUnbiasedVariance(long narr, const double* const val_arr)
{
...
double MiMath::GetRMS(long narr, const double* const val_arr)
{
    if(narr < 1){
        printf("ERROR: %s: %u: %s(): bad narr (= %ld)\n",
               __FILE__, __LINE__, __func__, narr);
...
double MiMath::GetMin(vector<double> vec)
{
    double val = *min_element(vec.begin(), vec.end());
    return val;
}

double MiMath::GetMax(vector<double> vec)
{
    double val = *max_element(vec.begin(), vec.end());
    return val;
}

double MiMath::GetAdd(vector<double> vec)
{
    long narr = vec.size();
...
double MiMath::GetAMean(vector<double> vec)
{
    long narr = vec.size();
    double* val_arr = new double [narr];
    for(long idata = 0; idata < narr; idata ++){
...
double MiMath::GetVariance(vector<double> vec)
{
    long narr = vec.size();
    double* val_arr = new double [narr];
    for(long idata = 0; idata < narr; idata ++){
...
double MiMath::GetStddev(vector<double> vec)
{
    long narr = vec.size();
    double* val_arr = new double [narr];
    for(long idata = 0; idata < narr; idata ++){
...
double MiMath::GetUnbiasedVariance(vector<double> vec)
{
    long narr = vec.size();
    double* val_arr = new double [narr];
    for(long idata = 0; idata < narr; idata ++){
...
double MiMath::GetSqrtOfUnbiasedVariance(vector<double> vec)
{
    long narr = vec.size();
    double* val_arr = new double [narr];
    for(long idata = 0; idata < narr; idata ++){
...
double MiMath::GetRMS(vector<double> vec)
{
    long narr = vec.size();
    double* val_arr = new double [narr];
    for(long idata = 0; idata < narr; idata ++){
...
void MiMath::GetAdd(long narr, const double* const val_arr, const double* const val_err_arr,
...
void MiMath::GetAMean(long narr, const double* const val_arr, const double* const val_err_arr,
                        double* const amean_ptr, double* const amean_err_ptr)
{
    if(narr < 1){
        printf("ERROR: %s: %u: %s(): bad narr (= %ld)\n",
...
int MiMath::GetWMean(long narr, const double* const val_arr, const double* const val_err_arr,
                       double* const wmean_ptr, double* const wmean_err_ptr,
...
void MiMath::GetAddWithMask(long narr, const double* const val_arr, const double* const val_err_arr,
...
int MiMath::GetWMeanWithMask(long narr, const double* const val_arr, const double* const val_err_arr,
                               const int* const mask_arr,
                               double* const wmean_ptr, double* const wmean_err_ptr,
                               vector<long>* const index_bad_vec_ptr)
{
...
// ichiji-hokan
double MiMath::IntPolLin(double xval,
...
double MiMath::IntPolLin(double xval, double yval,
...
double MiMath::ProbGaus(double xval, double mu, double sigma)
{
...
double MiMath::ProbGausAsym(double xval, double mu,
...
// for binning
long MiMath::GetNbin(double val_lo, double val_up, double delta_val, string mode)
{
    if(val_up <= val_lo){
...
long MiMath::GetNbinEven(double val_lo, double val_up, double delta_val)
{
...
void MiMath::GetRangeQdp(double min, double max,
...
int MiMath::IsSorted(long narr, const double* const val_arr)
{
    if(narr < 1){
        MPrintErr("bad narr");
        abort();
...
double* const MiMath::GenArray(vector<double> vec)
{
    long narr = vec.size();
    double* val_arr = new double [narr];
    for(long idata = 0; idata < narr; idata ++){
...
// inner product
double MiMath::GetInProd(double vec0_xval, double vec0_yval,
