...
int MiFits::InFitsImageF(string infile,
...
int MiFits::InFitsCubeF(string infile,
                         const MiImgInfo* const img_info,
                         double** const data_arr_ptr)
{
    //
...
int MiFits::OutFitsImageF(string outdir, string outfile_head, string tag,
...
int MiFits::OutFitsCubeF(string outdir, string outfile_head, string tag,
                          int naxis, const long* const naxes,
                          const float* const data_arr)
{
    int status = 0;
