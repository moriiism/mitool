#ifndef MXKWTOOL_MXKWTIMING_LASSO_ARG_LASSO_H_
#define MXKWTOOL_MXKWTIMING_LASSO_ARG_LASSO_H_

#include "mxkw_base.h"

class ArgValLasso : public MxkwArgBase{
public:
    explicit ArgValLasso(string title = "") :
        MxkwArgBase("ArgValLasso", title),
        progname_(""),
        file_(""),
        telescope_(""),
        tunit_(""),
...
#endif // MXKWTOOL_MXKWTIMING_LASSO_ARG_LASSO_H_
