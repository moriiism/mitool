...
void ArgValLomb::Init(int argc, char* argv[])
{
    progname_ = "lomb";
...
void ArgValLomb::Print(FILE* fp) const
{
...
void ArgValLomb::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
...
void ArgValLomb::Usage(FILE* fp) const
{
    fprintf(fp,
