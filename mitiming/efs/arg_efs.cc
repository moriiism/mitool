...
void ArgValEfs::Init(int argc, char* argv[])
{
    progname_ = "efs";
...
void ArgValEfs::Print(FILE* fp) const
{
...
void ArgValEfs::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
        MPrintInfo("start...");
    }
