...
void ArgValEfsOrbmod::Init(int argc, char* argv[])
{
    progname_ = "efs_orbmod";
...
void ArgValEfsOrbmod::Print(FILE* fp) const
{
...
void ArgValEfsOrbmod::SetOption(int argc, char* argv[], option* long_options)
{
   if(0 < g_flag_verbose){
