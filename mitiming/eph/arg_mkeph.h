#ifndef MORIIISM_MITOOL_MITIMING_EPH_ARG_MKEPH_H_
#define MORIIISM_MITOOL_MITIMING_EPH_ARG_MKEPH_H_

#include "mi_base.h"

class ArgValMkEph : public MiArgBase{
public:
    ArgValMkEph() :
        MiArgBase(),
        progname_(""),
...
#endif // MORIIISM_MITOOL_MITIMING_EPH_ARG_MKEPH_H_
