...
void ArgValFcs::Init(int argc, char* argv[])
{
    progname_ = "fcs";
...
void ArgValFcs::Print(FILE* fp) const
{
...
void ArgValFcs::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
...
void ArgValFcs::Usage(FILE* fp) const
{
    fprintf(fp,
