...
int main(int argc, char* argv[]){
    ...
    ArgValMklcPulsarBinaryMaxi* argval = new ArgValMklcPulsarBinaryMaxi;
    ...
    binorb->Load(argval->GetOrbfile());
    BinaryOrbObsTimeFunc* func_bin_orb_obs_time = new BinaryOrbObsTimeFunc;
    func_bin_orb_obs_time->SetBinorb(binorb->GetPeriod(), binorb->GetAxSini(),
                                     binorb->GetEcc(), binorb->GetTimePeri(),
                                     binorb->GetAnglePeri());
    binorb->SetFuncBinOrbObsTimeForTimeObj(func_bin_orb_obs_time);
    binorb->Print(stdout);
    binorb->Print(fp_log);
