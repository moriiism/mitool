...
void ArgValSimLcplsRate::Init(int argc, char* argv[])
{
    progname_ = "sim_lcpls_rate";
...
void ArgValSimLcplsRate::Print(FILE* fp) const
{
...
void ArgValSimLcplsRate::Usage(FILE* fp) const
{
    fprintf(fp,
