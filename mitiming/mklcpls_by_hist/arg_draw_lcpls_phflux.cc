...
void ArgValDrawLcplsPhflux::Init(int argc, char* argv[])
{
    progname_ = "draw_lcpls_phflux";
...
void ArgValDrawLcplsPhflux::Print(FILE* fp) const
{
...
void ArgValDrawLcplsPhflux::Null()
{
    progname_     = "";
    hist_pls_     = "";
    hist_info_    = "";
...
void ArgValDrawLcplsPhflux::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
        MPrintInfo("start...");
    }
...
void ArgValDrawLcplsPhflux::Usage(FILE* fp) const
{
    fprintf(fp,
