...
export LD_LIBRARY_PATH=/soft/heasoft/6.33.2/x86_64-pc-linux-gnu-libc2.39/lib:\
/soft/blas/3.12.0/lib:\
/soft/lapack/3.12.0/lib:\
/soft/gsl/2.8/lib:\
/soft/root/6.32.02/lib:${LD_LIBRARY_PATH}
export PATH=/soft/root/6.32.02/bin:${PATH}
...
HEADAS_VER=6.33.2
export HEADAS=/soft/heasoft/${HEADAS_VER}/x86_64-pc-linux-gnu-libc2.39
